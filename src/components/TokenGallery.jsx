...
const TYPE = [
  ...
  { group: 'Subheading' },
  { cls: 'type-subheading-bold',    name: 'subheading.bold',    spec: 'Bold · 22 / 32',    sample: HEAD },
  { cls: 'type-subheading-regular', name: 'subheading.regular', spec: 'Regular · 22 / 32', sample: HEAD },
  { group: 'Body' },
