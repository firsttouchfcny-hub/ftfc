...
| Element | Status | Notes |
|---|---|---|
| Nav layout | ✅ 🔨 | **Updated (2026-08-30)** to frame `3652:10656`: the **club badge** anchors the far left at 44px, and Rules / Gear / avatar travel together on the right in one 8px group. Outside padding 20px (was 16). The badge is the same mark the onboarding screens use, now **`ftfc-badge.svg`** — Cristian supplied a clean vector, replacing the downscaled PNG in both places. Sharp at any density, and half the bytes. Rendered as a mark, not a button, as drawn |
